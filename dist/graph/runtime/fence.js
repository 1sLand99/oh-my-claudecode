 ...
 */
import { closeSync, constants as fsConstants, fstatSync, mkdirSync, openSync, readFileSync, renameSync, statSync, unlinkSync, writeSync, } from "fs";
...
export class FileOwnershipFence {
    ...
    async acquire() {
        ...
        for (;;) {
            ...
            try {
                const parsed = JSON.parse(readFileSync(tombstone, "utf8"));
                if (parsed !== null &&
