 ...
 */
import { closeSync, constants, fstatSync, ftruncateSync, fsyncSync, lstatSync, linkSync, mkdirSync, openSync, readdirSync, readSync, realpathSync, renameSync, unlinkSync, writeSync, } from 'fs';
...
function newestSessionMarkerClaim(directory, target, sessionId) {
    ...
    try {
        ...
        for (const name of names) {
            ...
            if (!isPathWithin(target.context.omcRoot.path, resolved))
                continue;
